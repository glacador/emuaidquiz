...
const condition = config.conditions.find(c => c.slug === 'keratosis-pilaris')!

export const metadata: Metadata = {
  title: `Your Results - Keratosis Pilaris Pattern | ${config.funnel.name}`,
...
export default async function KeratosisPilarisResultsPage({ searchParams }: PageProps) {
