...
const condition = config.conditions.find(c => c.slug === 'aftershave-folliculitis')!

export const metadata: Metadata = {
  title: `Your Results - After-Shave Folliculitis | ${config.funnel.name}`,
...
export default async function AftershaveFolliculitisResultsPage({ searchParams }: PageProps) {
