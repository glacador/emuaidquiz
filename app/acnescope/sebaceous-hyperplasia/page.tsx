...
const condition = config.conditions.find(c => c.slug === 'sebaceous-hyperplasia')!

export const metadata: Metadata = {
  title: `Your Results - Sebaceous Hyperplasia | ${config.funnel.name}`,
...
export default async function SebaceousHyperplasiaResultsPage({ searchParams }: PageProps) {
