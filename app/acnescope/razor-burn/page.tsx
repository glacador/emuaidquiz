...
const condition = config.conditions.find(c => c.slug === 'razor-burn')!

export const metadata: Metadata = {
  title: `Your Results - Razor Burn | ${config.funnel.name}`,
...
export default async function RazorBurnResultsPage({ searchParams }: PageProps) {
