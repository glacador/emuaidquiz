...
const condition = config.conditions.find(c => c.slug === 'staph-folliculitis')!

export const metadata: Metadata = {
  title: `Your Results - Staphylococcal Folliculitis | ${config.funnel.name}`,
...
export default async function StaphFolliculitisResultsPage({ searchParams }: PageProps) {
