...
const condition = config.conditions.find(c => c.slug === 'perioral')!

export const metadata: Metadata = {
  title: `Your Results - Perioral Dermatitis Pattern | ${config.funnel.name}`,
...
export default async function PerioralResultsPage({ searchParams }: PageProps) {
