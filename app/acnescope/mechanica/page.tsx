...
const condition = config.conditions.find(c => c.slug === 'mechanica')!

export const metadata: Metadata = {
  title: `Your Results - Acne Mechanica Pattern | ${config.funnel.name}`,
...
export default async function MechanicaResultsPage({ searchParams }: PageProps) {
