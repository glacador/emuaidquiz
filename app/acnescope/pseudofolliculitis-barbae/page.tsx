...
const condition = config.conditions.find(c => c.slug === 'pseudofolliculitis-barbae')!

export const metadata: Metadata = {
  title: `Your Results - Pseudofolliculitis Barbae | ${config.funnel.name}`,
...
export default async function PseudofolliculitisResultsPage({ searchParams }: PageProps) {
