...
const condition = config.conditions.find(c => c.slug === 'folliculitis-decalvans')!

export const metadata: Metadata = {
  title: `Your Results - Folliculitis Decalvans | ${config.funnel.name}`,
...
export default async function FolliculitisDecalvansResultsPage({ searchParams }: PageProps) {
