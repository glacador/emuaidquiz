...
const condition = config.conditions.find(c => c.slug === 'hormonal')!

export const metadata: Metadata = {
  title: `Your Results - Hormonal Acne Pattern | ${config.funnel.name}`,
...
export default async function HormonalResultsPage({ searchParams }: PageProps) {
