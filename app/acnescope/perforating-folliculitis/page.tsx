...
const condition = config.conditions.find(c => c.slug === 'perforating-folliculitis')!

export const metadata: Metadata = {
  title: `Your Results - Perforating Folliculitis | ${config.funnel.name}`,
...
export default async function PerforatingFolliculitisResultsPage({ searchParams }: PageProps) {
