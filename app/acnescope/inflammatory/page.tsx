...
const condition = config.conditions.find(c => c.slug === 'inflammatory')!

export const metadata: Metadata = {
  title: `Your Results - Inflammatory Acne Pattern | ${config.funnel.name}`,
...
export default async function InflammatoryResultsPage({ searchParams }: PageProps) {
