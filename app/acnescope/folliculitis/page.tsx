...
const condition = config.conditions.find(c => c.slug === 'folliculitis')!

export const metadata: Metadata = {
  title: `Your Results - Folliculitis Pattern | ${config.funnel.name}`,
...
export default async function FolliculitisResultsPage({ searchParams }: PageProps) {
