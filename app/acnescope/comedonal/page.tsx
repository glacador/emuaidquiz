...
const condition = config.conditions.find(c => c.slug === 'comedonal')!

export const metadata: Metadata = {
  title: `Your Results - Comedonal Acne Pattern | ${config.funnel.name}`,
...
export default async function ComedonalResultsPage({ searchParams }: PageProps) {
