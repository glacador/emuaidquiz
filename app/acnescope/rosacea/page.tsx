...
const condition = config.conditions.find(c => c.slug === 'rosacea')!

export const metadata: Metadata = {
  title: `Your Results - Rosacea Pattern | ${config.funnel.name}`,
...
export default async function RosaceaResultsPage({ searchParams }: PageProps) {
