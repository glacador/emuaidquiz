...
const condition = config.conditions.find(c => c.slug === 'fungal')!

export const metadata: Metadata = {
  title: `Your Results - Fungal Acne Pattern | ${config.funnel.name}`,
...
export default async function FungalResultsPage({ searchParams }: PageProps) {
