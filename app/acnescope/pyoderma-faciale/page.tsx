...
const condition = config.conditions.find(c => c.slug === 'pyoderma-faciale')!

export const metadata: Metadata = {
  title: `Your Results - Pyoderma Faciale | ${config.funnel.name}`,
...
export default async function PyodermaFacialeResultsPage({ searchParams }: PageProps) {
