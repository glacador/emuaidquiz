...
const condition = config.conditions.find(c => c.slug === 'pregnancy-folliculitis')!

export const metadata: Metadata = {
  title: `Your Results - Pruritic Folliculitis of Pregnancy | ${config.funnel.name}`,
...
export default async function PregnancyFolliculitisResultsPage({ searchParams }: PageProps) {
