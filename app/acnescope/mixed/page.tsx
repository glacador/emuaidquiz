...
const condition = config.conditions.find(c => c.slug === 'mixed')!

export const metadata: Metadata = {
  title: `Your Results - Mixed Pattern | ${config.funnel.name}`,
...
export default async function MixedResultsPage({ searchParams }: PageProps) {
