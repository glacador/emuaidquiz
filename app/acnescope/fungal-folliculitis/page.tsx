...
const condition = config.conditions.find(c => c.slug === 'fungal-folliculitis')!

export const metadata: Metadata = {
  title: `Your Results - Fungal Folliculitis | ${config.funnel.name}`,
...
export default async function FungalFolliculitisResultsPage({ searchParams }: PageProps) {
