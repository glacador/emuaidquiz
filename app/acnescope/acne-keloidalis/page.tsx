...
const condition = config.conditions.find(c => c.slug === 'acne-keloidalis')!

export const metadata: Metadata = {
  title: `Your Results - Acne Keloidalis Nuchae | ${config.funnel.name}`,
...
export default async function AcneKeloidalisResultsPage({ searchParams }: PageProps) {
