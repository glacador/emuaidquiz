...
const condition = config.conditions.find(c => c.slug === 'acne-conglobata')!

export const metadata: Metadata = {
  title: `Your Results - Acne Conglobata | ${config.funnel.name}`,
...
export default async function AcneConglobataResultsPage({ searchParams }: PageProps) {
